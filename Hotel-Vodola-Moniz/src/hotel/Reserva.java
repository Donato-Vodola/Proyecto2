...
public class Reserva {
    ...
    public Reserva(int ci, String primerNombre, String segundoNombre, String email, String genero, String tipo_hab, String celular, LocalDate llegada, LocalDate salida) {
        this.ci = ci;
        this.primerNombre = primerNombre;
        this.segundoNombre = segundoNombre;
        this.email = email;
    ...
    public String String() {
        return primerNombre + "," + segundoNombre + "," + email + "," + genero + "," + tipo_hab + "," + celular + "," + llegada;
    }
   }
